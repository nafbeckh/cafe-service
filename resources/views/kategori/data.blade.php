                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nama_kategori" class="form-control" id="nama_kategori" placeholder="Masukkan Nama Kategori" minlength="2" maxlength="25" required>
                                <span id="err_nama_kategori" class="error invalid-feedback" style="display: hide;"></span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form id="formEdit" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="form-group row">
                            <label for="edit_nama_kategori" class="col-sm-3 col-form-label">Nama Kategori :</label>
                            <div class="col-sm-9">
                                <input type="text" name="nama_kategori" class="form-control" id="edit_nama_kategori" placeholder="Masukkan Nama Kategori" minlength="2" maxlength="25" required>
                                <span id="err_edit_nama_kategori" class="error invalid-feedback" style="display: hide;"></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#formDeleteBatch').submit(function(event) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('kategori.destroy.batch') }}",
                data: $(form).serialize(),
                beforeSend: function() {
                    console.log('otw')
                },
