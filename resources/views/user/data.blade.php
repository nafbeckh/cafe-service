            ...
            <form id="form" action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="password" name="password" class="form-control" id="password" placeholder="Masukkan Password" minlength="5" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="role" id="role" class="form-control roleAdd" style="width: 100%;" required>
            ...
            <form id="formEdit" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="username" name="username" class="form-control" id="edit_username" placeholder="Masukkan Username" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="password" name="password" class="form-control" id="edit_password" placeholder="Masukkan Password" minlength="5">
                            <span id="err_edit_password" class="error invalid-feedback" style="display: hide;"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="edit_password2" class="col-sm-3 col-form-label">Konfirmasi Password :</label>
                        <div class="col-sm-9">
                            <input type="password" name="password2" class="form-control" id="edit_password2" placeholder="Masukkan Konfirmasi Password" minlength="5">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="role" id="edit_role" class="form-control roleEdit" style="width: 100%;" required>
                                <option value="admin">Admin</option>
                                <option value="chef">Chef</option>
                                <option value="waiter">Waiter</option>
                            </select>
        ...
        var table = $('#tableData').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    title: 'Foto',
                    render: function(data, type, row, meta) {
                        let text = `<img src="assets/dist/img/${data}" width="25" height="25">`;
                        return text;
                    }
                },
                {
